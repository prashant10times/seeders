...
func GetTableOptimizeConfigs() map[string]TableOptimizeConfig {
	return map[string]TableOptimizeConfig{
		...
		"event_exhibitor_ch": {
			...
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"event_id", "edition_id", "exhibitorSourceId"},
		},
		"event_speaker_ch": {
			TableName:             "event_speaker_ch",
			TempTableName:         "event_speaker_temp",
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"event_id", "edition_id", "user_id", "speakerSourceId"},
		},
		"event_sponsors_ch": {
			TableName:             "event_sponsors_ch",
			TempTableName:         "event_sponsors_temp",
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"event_id", "edition_id", "sponsorSourceId"},
		},
		"event_visitors_ch": {
		...
		"company_speaker_ch": {
			TableName:             "company_speaker_ch",
			TempTableName:         "company_speaker_temp",
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"eventId", "editionId", "id"},
		},
		"company_visitor_ch": {
			TableName:             "company_visitor_ch",
			TempTableName:         "company_visitor_temp",
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"eventId", "editionId", "id"},
		},
		"company_classification_ch": {
			TableName:             "company_classification_ch",
			TempTableName:         "company_classification_temp",
			PartitionExpression:   "",
			DuplicateCheckColumns: []string{"classification_type", "classification_name", "source_id"},
		},
	}
}
